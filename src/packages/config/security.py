...
ALERT_TEST_EVENTS_ENABLED_ENV = "ALERT_TEST_EVENTS_ENABLED"
...
def alert_test_events_enabled() -> bool:
    """개발 콘솔의 테스트 알림 발생 capability."""
    return env_enabled(ALERT_TEST_EVENTS_ENABLED_ENV)
