    ...
    def fake_evidence(self) -> JsonObject:
        return {
            ...
            "kubernetes": {
                ...
                "events": [
                    Settings.K8S_READINESS_FAILED_EVENT,
                    Settings.K8S_BACKOFF_EVENT,
                ],
            },
            "metrics": {
            ...
            "traces": {
                "source": Settings.FAKE_OTEL_SOURCE,
                "slow_span": Settings.OTEL_SLOW_SPAN,
            },
        }
                    ...
                    "result": [
                        {
                            ...
                            "value": [
                                time.time(),
                                Settings.PROMETHEUS_VECTOR_VALUE,
                            ],
                        }
                    ],
                },
