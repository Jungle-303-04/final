  ...
  return (
    <Field label="Run filter">
      <select className="input" value={runFilter} onChange={e => onRunFilterChange(e.target.value as ReleaseRunFilter)}>
        ...
        <option value="active_change_freeze">Active freeze</option>
...
function RunSummary({
  ...
  const opsSignals: RunSummarySignal[] = [
    ...
    { label: 'Succeeded', count: summary.succeeded_runs ?? 0, filter: 'succeeded' },
    { label: 'Failed', count: summary.failed_runs ?? 0, filter: 'failed' },
    { label: 'Paused', count: summary.paused_runs ?? 0, filter: 'paused' },
    { label: 'Cancelled', count: summary.cancelled_runs ?? 0, filter: 'cancelled' },
    ...
    { label: 'Policy override', count: summary.policy_override_runs ?? 0, filter: 'policy_override' },
    { label: 'Freeze override', count: summary.change_freeze_override_runs ?? 0, filter: 'change_freeze_override' },
    { label: 'Active freeze', count: summary.active_change_freeze_runs ?? 0, filter: 'active_change_freeze' },
