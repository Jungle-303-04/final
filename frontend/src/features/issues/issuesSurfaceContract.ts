...
export interface IssuesSurfaceCopy {
  ...
  severityTooltip: (value: string) => string;
  valueUnknown: string;
  recoveryCardProgress: (state: "active" | "approval" | "completed" | "failed") => string;
  situationSummary: string;
  situationSummaryText: (symptom: string, cause: string, status: string) => string;
  ...
  viewRecoveryAction: string;
  actionRisk: string;
  time: string;
  evidenceCoverage: (confirmed: number, total: number) => string;
  causeCandidates: string;
  itemCount: (count: number) => string;
  finalJudgementText: (cause: string, symptom: string) => string;
  memoryRecommendation: string;
  reviewRecoveryPlan: string;
  evidenceNameLabel: (name: string) => string;
  recommendedRecoveryActions: string;
  otherRecoveryCandidates: string;
  ...
  selectRecoveryAction: string;
  riskLabel: (severity: string | null) => string;
