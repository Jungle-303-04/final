...
export const COPY: IssuesSurfaceCopy = {
  ...
  namespace: "Namespace",
  resourceKind: "Kind",
  analysisComplete: "Root cause analysis complete",
  severityFilterLabel: "Severity filter",
  severityFilterAll: "All severities",
  severityCritical: "Critical",
  severityWarning: "Warning",
  severityHealthy: "Healthy",
  severityTooltip: (value) => `Severity: ${value}`,
  valueUnknown: "Unknown",
  recoveryCardProgress: (state) => state,
  situationSummary: "Situation summary",
  situationSummaryText: (symptom, cause, status) => `${symptom} · ${cause} · ${status}`,
  noAdditionalAction: "No additional action",
  impactScope: "Impact scope",
  finalJudgement: "Final assessment",
  finalCause: "Final cause",
  evidenceSummaryTitle: "Evidence summary",
  evidenceDetailsTitle: "Evidence details",
  recommendedActionTitle: "Recommended action",
  viewRecoveryAction: "View recovery actions",
  actionRisk: "Action risk",
  time: "Time",
  evidenceCoverage: (confirmed, total) => `${confirmed} of ${total}`,
  causeCandidates: "Cause candidates",
  itemCount: (count) => `${count} items`,
  finalJudgementText: (cause, symptom) => `${cause} · ${symptom}`,
  memoryRecommendation: "Review the memory limit adjustment",
  reviewRecoveryPlan: "Review the recovery plan",
  evidenceNameLabel: (name) => name,
  recommendedRecoveryActions: "Recommended recovery action",
  otherRecoveryCandidates: "Other recovery candidates",
  recommendationReason: "Recommendation reason",
  expectedOutcome: "Expected outcome",
  riskExplanation: "Risk explanation",
  actionToRun: "Action to run",
  validationChecks: "Success criteria",
  rollbackAction: "Rollback action",
  selectRecoveryAction: "Select recovery action",
  riskLabel: (severity) => severity ?? "Unknown",
