...
import { IconAlertTriangle, IconCheckCircle } from '@/shared/ui/icons';
...
export default function VerifyEmailView() {
  ...
  return (
    <AuthLayout title="이메일 검증">
      {ok
        ? <EmptyState icon={<IconCheckCircle size={26} />} title="검증 완료" description="관리자 승인 후 로그인할 수 있습니다." action={<Link to="/login"><Button variant="primary">로그인으로</Button></Link>} />
        : (
