        ...
        >
          <motion.div variants={listItem} className="inline-flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-title font-semibold text-text-primary">KubeHeal Console</p>
              <p className="text-label text-text-muted">Kubernetes 운영 자동화</p>
            </div>
          </motion.div>
          <motion.div variants={listItem} className="grid gap-3">
            <h2 className="text-page font-semibold text-text-primary">인시던트 탐지부터 복구 조치까지 한 화면에서 관리</h2>
            <p className="max-w-lg text-body leading-6 text-text-secondary">
          ...
          <Card className="w-full max-w-md p-6 sm:p-8">
            <div className="mb-6 grid gap-4">
              <div className="flex items-center gap-3 lg:hidden">
                <BrandMark />
                <span className="text-title font-semibold text-text-primary">KubeHeal Console</span>
              </div>
...
function BrandMark() {
  return (
    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-panel bg-brand text-title font-semibold text-on-accent shadow-soft">
      K
    </span>
  );
}
