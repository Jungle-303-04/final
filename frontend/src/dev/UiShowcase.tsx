...
type DevIconProps = SVGProps<SVGSVGElement> & { size?: number };

function iconProps({ size = 20, ...rest }: DevIconProps): SVGProps<SVGSVGElement> {
  return {
    width: size,
    height: size,
    viewBox: '0 0 24 24',
...
function IconPlus(props: DevIconProps) {
  return <svg {...iconProps(props)}><path d="M12 5v14" /><path d="M5 12h14" /></svg>;
}

function IconTrash(props: DevIconProps) {
  return <svg {...iconProps(props)}><path d="M4 7h16" /><path d="M9 7V5.5A1.5 1.5 0 0 1 10.5 4h3A1.5 1.5 0 0 1 15 5.5V7" /><path d="M6.5 7 7.3 19.5A1.6 1.6 0 0 0 8.9 21h6.2a1.6 1.6 0 0 0 1.6-1.5L17.5 7" /><path d="M10 11v6" /><path d="M14 11v6" /></svg>;
}

function IconCheck(props: DevIconProps) {
  return <svg {...iconProps(props)}><path d="m5 12.5 4.5 4.5L19 7.5" /></svg>;
}

function IconFile(props: DevIconProps) {
  return <svg {...iconProps(props)}><path d="M14 3H7a1.5 1.5 0 0 0-1.5 1.5v15A1.5 1.5 0 0 0 7 21h10a1.5 1.5 0 0 0 1.5-1.5V7.5L14 3Z" /><path d="M14 3v4.5h4.5" /></svg>;
}

function IconAlertTriangle(props: DevIconProps) {
  return <svg {...iconProps(props)}><path d="M12 3.8 2.9 19.2a1 1 0 0 0 .9 1.5h16.4a1 1 0 0 0 .9-1.5L12 3.8Z" /><path d="M12 9.5v4.5" /><path d="M12 17.2v.1" /></svg>;
}
