...
export const physicalTopologyServerSchema = z.strictObject({
  ...
  allocatable_cpu_mcores: nullableMetricSchema,
  allocatable_mem_mib: nullableMetricSchema,
  pod_capacity: z.number().int().nonnegative().nullable(),
...
export const physicalTopologyPodSchema = z.strictObject({
  ...
  owner_kind: z.string().min(1).nullable().optional(),
  owner_name: z.string().min(1).nullable().optional(),
  owner_uid: z.string().min(1).nullable().optional(),
  owner_references_complete: z.boolean().nullable().optional(),
  workload_key: z.string().min(1).nullable().optional(),
  replica_group_key: z.string().min(1).nullable().optional(),
  replica_group_kind: z.string().min(1).nullable().optional(),
  replica_group_name: z.string().min(1).nullable().optional(),
  replica_group_uid: z.string().min(1).nullable().optional(),
