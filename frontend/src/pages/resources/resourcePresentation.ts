...
const PRESENTATIONS: Record<string, {
  ...
  deployment: { labelKey: "resources.type.deployment", category: "workloads", icon: Rocket, order: 20 },
  daemonset: { labelKey: "resources.type.daemonset", category: "workloads", icon: Rows3, order: 30 },
  statefulset: { labelKey: "resources.type.statefulset", category: "workloads", icon: DatabaseZap, order: 40 },
  replicaset: { labelKey: "resources.type.replicaset", category: "workloads", icon: Copy, order: 50 },
  job: { labelKey: "resources.type.job", category: "workloads", icon: Play, order: 60 },
  cronjob: { labelKey: "resources.type.cronjob", category: "workloads", icon: Clock3, order: 70 },
  ...
  networkpolicy: { labelKey: "resources.type.networkpolicy", category: "networking", icon: ShieldCheck, order: 40 },
  ...
  hpa: { labelKey: "resources.type.hpa", category: "configuration", icon: Scaling, order: 30 },
  ...
  storageclass: { labelKey: "resources.type.storageclass", category: "storage", icon: Database, order: 30 },
  resourcequota: { labelKey: "resources.type.resourcequota", category: "configuration", icon: Gauge, order: 40 },
