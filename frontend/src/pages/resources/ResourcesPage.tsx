    ...
    >
      <div
        className={state.detailRequested
          ? state.detailFull
            ? "hidden min-w-0 overflow-y-auto lg:block lg:basis-0 lg:flex-none lg:overflow-hidden lg:opacity-0 lg:pointer-events-none lg:transition-[flex-basis,opacity] lg:duration-[220ms] lg:ease-out motion-reduce:transition-none"
            : "hidden min-w-0 flex-1 overflow-y-auto lg:block lg:opacity-100 lg:transition-[flex-basis,opacity] lg:duration-[220ms] lg:ease-out motion-reduce:transition-none"
      ...
      {state.detailRequested ? (
        <div
          className={cn(
            "min-w-0 w-full basis-full shrink-0 bg-background transition-[flex-basis,border-color] duration-[220ms] ease-out motion-reduce:transition-none",
