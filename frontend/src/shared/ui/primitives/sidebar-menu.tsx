...
const SIDEBAR_MENU_INTERACTIVE_CLASSES =
  "group/sidebar-menu-button flex h-(--product-navigation-row-height) w-full min-w-0 items-center gap-[0.859375rem] overflow-hidden rounded-[var(--product-radius-md)] border border-transparent px-[0.796875rem] text-left text-[length:var(--type-body)] leading-[var(--type-body-line)] font-medium text-muted-foreground outline-none transition-[color,background-color,border-color] duration-(--motion-instant) hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 focus-visible:ring-sidebar-ring data-[sidebar-state=collapsed]:justify-center data-[sidebar-state=collapsed]:px-0 data-[sidebar-state=collapsed]:[&>span:last-child]:sr-only data-active:bg-primary/10 data-active:font-bold data-active:text-primary aria-disabled:pointer-events-none aria-disabled:opacity-50 motion-reduce:transition-none forced-colors:data-active:border-[Highlight] forced-colors:data-active:bg-[Highlight] forced-colors:data-active:text-[HighlightText] forced-colors:focus-visible:outline forced-colors:focus-visible:outline-2 forced-colors:focus-visible:outline-offset-2 forced-colors:focus-visible:outline-[CanvasText] forced-colors:aria-disabled:border-[GrayText] forced-colors:aria-disabled:text-[GrayText] forced-colors:aria-disabled:opacity-100";
