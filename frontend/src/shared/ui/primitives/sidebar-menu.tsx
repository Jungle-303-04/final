...
const SIDEBAR_MENU_INTERACTIVE_CLASSES =
  "group/sidebar-menu-button flex h-9 w-full min-w-0 items-center gap-3 overflow-hidden rounded-lg border border-transparent px-2.5 text-left text-sm font-medium text-sidebar-foreground/70 outline-none transition-[color,background-color,border-color] duration-150 ease-out hover:border-sidebar-primary/25 hover:bg-sidebar-primary/10 hover:text-sidebar-foreground focus-visible:bg-sidebar-primary/10 focus-visible:text-sidebar-foreground focus-visible:ring-2 focus-visible:ring-sidebar-ring data-active:border-sidebar-primary/40 data-active:bg-sidebar-primary/15 data-active:text-sidebar-accent-foreground data-[sidebar-state=collapsed]:justify-center data-[sidebar-state=collapsed]:px-0 data-[sidebar-state=collapsed]:[&>span:last-child]:sr-only aria-disabled:pointer-events-none aria-disabled:opacity-50 motion-reduce:transition-none forced-colors:hover:bg-[Highlight] forced-colors:hover:text-[HighlightText] forced-colors:focus-visible:bg-[Highlight] forced-colors:focus-visible:text-[HighlightText] forced-colors:focus-visible:outline forced-colors:focus-visible:outline-2 forced-colors:focus-visible:outline-offset-2 forced-colors:focus-visible:outline-[CanvasText] forced-colors:aria-disabled:border-[GrayText] forced-colors:aria-disabled:text-[GrayText] forced-colors:aria-disabled:opacity-100";
