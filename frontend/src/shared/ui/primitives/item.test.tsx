...
describe("product-owned Item", () => {
  ...
  it("renders navigation as an anchor with a required destination", () => {
    ...
    expect(link.getAttribute("href")).toBe("/resources/pods");
  ...
  it.each([
    ...
    ["link role override", { as: "a", href: "/", role: "button" }],
...
function assertItemTypeContracts() {
  ...
  void <Item as="a" href="/resources">리소스</Item>;
  ...
  void <Item as="a" href="/" role="button">잘못된 링크 역할</Item>;
