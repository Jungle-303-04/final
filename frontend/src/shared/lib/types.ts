...
export interface ReleaseRunHandoffVerification { status: 'passed'|'warning'|'blocked'|'info'|string; message: string; evidence: string[]; override_reason?: string | null; production_targets: string[] }
