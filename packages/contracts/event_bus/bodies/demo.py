...
@event(EventSubject.DEMO_PING_REQUESTED)
...
@event(EventSubject.DEMO_PONG_REQUESTED)
@dataclass(frozen=True)
...
@event(EventSubject.DEMO_PONG_DELIVERED)
@dataclass(frozen=True)
...
@event(EventSubject.DEMO_PONG_FAILED)
@dataclass(frozen=True)
