...
def event(subject: str, source: str, payload: JsonObject, correlation_id: str | None = None, causation_id: str | None = None) -> EventEnvelope:
    ...
    return EventEnvelope(event_id=event_id, subject=subject, source=source, correlation_id=correlation, causation_id=causation, created_at=now_iso(), payload=payload)
