...
- `providers/metadata_workload_snapshots.py`: summary/detail Deployment snapshot, container image/probe/resources/PVC refs 요약, Deployment/Pod/ReplicaSet status 요약, 안전한 annotation 요약을 만든다.
