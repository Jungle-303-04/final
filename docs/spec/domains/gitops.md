...
| `def list_application_workflow_runs(self, workspace_id: str, application_id: str, *, limit: int = 100) -> list[JsonObject]` | 앱의 워크플로 실행 목록, `created_at DESC` | `src/domains/gitops/repository.py :: RepoChangeRepository.list_application_workflow_runs` |
