...
| `src/domains/target/evidence_policy.py :: default_evidence_provider_policy` | `(provider_key: str, interval_seconds: int) -> EvidenceProviderPolicy` | `enabled=True, interval_seconds, min_workers=1, max_workers=2, queries=<기본 쿼리 복사본>` |
