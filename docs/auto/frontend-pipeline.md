...
| D. 잔여 큐 소화 | in_progress | C done | api-needs.md의 requested 행을 고정 순서대로 처리한다. APIQ-027은 `b92d081eb`, batch APIQ-005/006/009/010/011/013/014/016/017/018은 `56c689e61`·`c875efb1f`·`004f23d52` 앵커로 문서 동기화했다. 남은 행은 APIQ-019 → APIQ-015다. 현재 untracked feature draft 때문에 이번 heartbeat의 batch 검증은 targeted API contract + docs/manifest 기준이며, D exit 전 깨끗한 full UI gate가 필요하다. | 각 행별 앵커 + full gate. 남은 requested가 0이거나 전부 blocked 사유 기록 |
