...
G5 · 진행 중 · e5d49f80a + 4bf34cd92 + b037911cd · 흡수 파생물·형식 단언·실사용 0 프론트 좀비 정리 517파일 +112/-117,950; 최종 Gate 29725862657 Backend 3,734 pass/3 skip + Frontend 2,261 pass, 잔여 중복 감사 계속
G7 · 배포 완주 · f5e43d76d5773d90998a548e5fd687e7e0be762a · Dev Gate 29725862657 + Dev Deploy 29726217807 success(11m07s), `/api/cost/nodes` post-deploy 3.050s·인증 direct 2.233s·SPA 2.209s HTTP 200, 인증 10라우트 smoke 통과, rollback 미실행
G7 · 배포 완주 · 1031ffd0d1b87c5de3ee795a58a2d5983a3f19f9 · 운영 보고서 3파일만의 변경인데 Dev Gate 29727037520 success(6m44s) + Dev Deploy 29727437693 success(11m39s)로 풀 검증·롤아웃이 실행됨; 무배포 경계 필요성 실측
G7 · 배포 실패 · 311b0dcc63562a228e8855f6036d33720136274d · Dev Gate 29728487959 success; Dev Deploy 29728837938 attempt 1(6m04s)·attempt 2(5m52s) 모두 PostgreSQL PVC full 연쇄의 pre-deploy health 7/7 status 000으로 롤아웃 전 중단, rollback 미실행·라이브 미반영
G7 · 배포 완주 · 311b0dcc63562a228e8855f6036d33720136274d · PostgreSQL PVC 20Gi full·`pg_wal/xlogtemp` ENOSPC→DB CrashLoop→gateway 0/2·worker 연쇄를 확정하고 PVC 20→40Gi 비파괴 확장; filesystem 39.3G/19.7G used/19.7G free·temp_files 0·SELECT 1·gateway 2/2·console 2/2·proxy 2/2·RCA janitor 1/1 확인 후 Dev Deploy 29728837938 attempt 3 success(11m10s), service/console configmap SHA·API/인증 10라우트 일치·rollback 미실행; G4 부분 유지
G7 · 배포 완주 · c72589442f · Dev Gate 29730968155 + Dev Deploy 29731314210 success(11m09s), 인벤토리 락 경합 완화 라이브 반영
G7 · 배포 완주 · 359e80927d00f24ed0ce0615b1eb5aeef9631e6a · Dev Gate 29731587650 + Dev Deploy 29732007275 success(10m55s), 단일 React 사전번들·인증 브라우저 라우트 스모크 통과
G7 · 로컬 개발 경로 · d51b805c2 · `make frontend-live`=`npm run dev`, 실백엔드·localhost:5173·strict port·포트별 Vite cacheDir로 통일; 5181/5183 동시 브라우저 HTTP 200·Kyro·실데이터·console/page error 0, `make gate-fast` success, push 대기
