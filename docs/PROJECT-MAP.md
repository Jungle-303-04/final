...
`domains.dashboard`의 timeline model/repository는 RCA, change correlation, retention query가 같은 테이블을 사용하므로 남아 있습니다. dashboard HTTP route, projection worker, frontend는 제거됐습니다.
