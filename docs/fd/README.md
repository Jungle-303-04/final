...
외부 기준 콘솔의 IA/UX 패턴을 참조하되, 이 저장소의 실제 백엔드 계약
(`src/packages/contracts/gateway/routes.py`)에 1:1 로 매핑해 설계한다.

**목표: 구현자가 이 문서만 읽고 한 번에 오류 없이 구현 가능한 수준의 명세.**
...
| 2 | [02-reference-map.md](02-reference-map.md) | 외부 기준 콘솔 참조 지도, 라이선스 경계, 대안 앱 | 1 |
