...
- [Target Agent Command / Evidence 구현 가이드](../member-guides/target-agent-command-evidence-flow.md)
...
13번 이후에는 [production-readiness](../../production-readiness.md)의 Target/Agent와 control-plane observability 기준을 따른다.
