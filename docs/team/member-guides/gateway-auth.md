...
이 영역을 작업할 때는 `services/management-api-gateway/gateway.py`, `services/management-api-gateway/auth.py`, `packages/shared/schemas.py`, `docs/team/conventions.md`를 먼저 읽어라.
