...
| `src/components/ui/button-group.tsx` | `src/product/shared/ui/primitives/button-group.tsx` | product-relative utility import, required accessible group name, protected neutral group/text/separator semantics, forced-colors disabled/focus treatment |
...
| `src/components/ui/tabs.tsx` | `src/product/shared/ui/primitives/tabs.tsx` | product-relative utility import, explicit controlled/uncontrolled selection contract, required tablist name, protected root/list/tab/panel semantics |
