// @opsia/k8s-ui — Shared Kubernetes UI types, utilities, and components
// Used by both opsia (OSS) and koala-frontend (Opsia platform)
...
// Cluster switcher (shared trigger+dropdown for OSS Opsia and Opsia Hub)
export * from './components/cluster-switcher'

// Namespace picker (shared scope-filter trigger+dropdown for OSS Opsia and
// Opsia Hub — pure presentation, data injected via props)
export * from './components/namespace-switcher'

// Scope pill — the shared bordered shell that groups the cluster + namespace
// segments into one unit (OSS header + Opsia Hub cluster top bar)
