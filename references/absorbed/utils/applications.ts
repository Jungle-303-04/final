...
//
// The wire shape mirrors opsia OSS's GET /api/applications response
...
export interface AppIdentity {
  ...
  portable?: boolean;
  /** Machine-readable provenance tier (opsia applications_identity.go):
...
export const APP_IDENTITY_ANNOTATION = "app.opsia.io/app";
...
export const CHIP_TONE = {
  rose: "bg-destructive text-destructive ring-destructive dark:bg-destructive/40 dark:text-destructive dark:ring-destructive",
  amber:
    "bg-warning text-warning ring-warning dark:bg-warning/40 dark:text-warning dark:ring-warning",
  emerald:
    "bg-success text-success ring-success dark:bg-success/40 dark:text-success dark:ring-success",
  ...
  muted: "bg-accent text-muted-foreground/75 ring-border",
} as const;
