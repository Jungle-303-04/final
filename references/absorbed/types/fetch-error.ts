...
// app already satisfies — both web/'s ApiError and opsia-hub-web's
// ApiError expose .status and .message. Living in @opsia-io/k8s-ui
...
// across the OSS binary and Opsia Hub.
