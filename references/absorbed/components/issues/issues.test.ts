...
describe('category/group label fallbacks', () => {
  ...
  it('keeps ordinary group chips neutral and emphasizes control-plane/unknown groups', () => {
    expect(groupBadgeClass('runtime')).toContain('text-muted-foreground')
    expect(groupBadgeClass('runtime')).not.toContain('ring-border/60')
    expect(groupBadgeClass('control_plane')).toContain('text-foreground')
    expect(groupBadgeClass('control_plane')).toContain('ring-border/60')
    expect(groupBadgeClass('unknown')).toContain('ring-border/60')
    expect(groupBadgeClass('some_future_group')).toContain('text-muted-foreground')
    expect(groupBadgeClass('some_future_group')).not.toContain('ring-border/60')
  })
})
