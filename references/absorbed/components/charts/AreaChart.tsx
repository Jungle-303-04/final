      ...
      {hoverData && (
        ...
        >
          <div className="bg-card border border-border rounded-lg shadow-lg px-3 py-2 text-xs whitespace-nowrap">
            <div className="text-muted-foreground/75 mb-1.5 font-mono">
            ...
            {hoverData.points.map((p, i) => (
              <div key={i} className="flex items-center gap-2 py-0.5">
                ...
                />
                <span className="text-muted-foreground font-mono" title={p.fullLabel}>
                  {p.label}
                </span>
                <span className="text-foreground font-semibold ml-auto pl-3 tabular-nums">
