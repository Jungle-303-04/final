...
function getIssueTooltip(issue: string | undefined): React.ReactNode {
  ...
  return (
    <div className="max-w-xs">
      <div className="font-medium text-destructive">{details.title}</div>
      <div className="text-muted-foreground text-[10px] mt-1">
        {details.description}
      </div>
      <div className="text-blue-400 text-[10px] mt-1.5 border-t border-border pt-1.5">
        💡 {details.action}
      </div>
    </div>
  );
...
export const K8sResourceNode = memo(function K8sResourceNode({
      ...
      <>
        ...
        <div
          className={cn(
            ...
            "selection border border-primary/30",
            "shadow-lg shadow-primary/20",
            selected && "ring-2 ring-primary",
          )}
        >
          <Icon className="h-5 w-5 shrink-0 text-accent-text" aria-hidden />
          <span className="text-sm font-medium text-primary">Internet</span>
  ...
  return (
    <>
      ...
      >
        {/* Content */}
        <div className={cn("pl-3 pr-3", isSmallNode ? "py-2" : "py-2.5")}>
          ...
          <div className="flex items-center gap-1.5 mb-0.5">
            <Icon
              ...
              aria-hidden
            />
            <span className="text-[10px] uppercase tracking-wide text-muted-foreground/75 font-medium">
            ...
            <div className="ml-auto flex items-center gap-1.5">
              {deploymentMembership && (
                <Tooltip
                  ...
                  position="right"
                >
                  <span className="inline-flex cursor-help items-center gap-1 rounded bg-popover px-1 py-0.5 text-[9px] font-medium normal-case tracking-normal text-muted-foreground/75">
              ...
              {onToggleReplicaSets && (
                <Tooltip content={nodeData.replicaSetsCollapsed ? 'Show ReplicaSet' : 'Hide stable ReplicaSet'} position="right">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded px-1 py-0.5 text-[9px] font-medium text-muted-foreground/75 hover:bg-popover hover:text-foreground"
                  >
              ...
              {canExpand && (
                ...
                >
                  <button
                    ...
                    className="p-0.5 hover:bg-popover rounded transition-colors"
                  >
          ...
          <div className="text-sm font-medium text-foreground truncate pr-1">
