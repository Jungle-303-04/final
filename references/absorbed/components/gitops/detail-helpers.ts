...
// =============================================================================
// Shared helpers used by both per-cluster Opsia's GitOps detail view (OSS
// web/src/components/gitops/GitOpsView.tsx) and Opsia Hub's fleet GitOps
// detail page (opsia-hub-web/src/pages/fleet/GitOpsDetailPage.tsx). Lives
