...
// =============================================================================
// mergeGitOpsTrees — used by Opsia Hub's fleet GitOps detail page to compose
...
//
// Single-cluster Opsia never needs this — for in-cluster apps the controller
// tree already has everything because Opsia runs in the same cluster as
// the workloads. The merge is what makes Opsia Hub's cross-cluster view
// strictly more complete than self-hosted Opsia, not just a list of apps.
//
...
// (Opsia Hub's fleet detail page) use to route resource-viewer clicks
