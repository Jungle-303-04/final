...
//
// Originally inline in OSS opsia/web/src/components/gitops/GitOpsView.tsx;
// extracted here so Opsia Hub's fleet detail page can mount the same rail
...
export function GitOpsGraphFilterRail({
  ...
  return (
    <aside className="min-h-0 overflow-y-auto bg-card/90 max-lg:h-48 max-lg:max-h-48">
