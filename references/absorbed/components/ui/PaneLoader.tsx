...
import opsiaLoadingIconAsset from '../../assets/product/loading-icon.svg'
...
const opsiaLoadingIcon = assetUrl(opsiaLoadingIconAsset)

// PaneLoader — center-of-pane loading state. The animated opsia icon is
  ...
  return (
    <div className={`flex items-center justify-center ${className}`} aria-live="polite">
      ...
      <span className="relative">
        <img src={opsiaLoadingIcon} alt="" aria-hidden className="w-11 h-11" />
        {/* Label style matches the splash surfaces (17px semibold tracking-tight,
            ...
            hand-off. */}
        <span className="absolute left-1/2 top-full mt-3 w-[min(24rem,calc(100vw-2rem))] -translate-x-1/2 text-center text-[17px] font-semibold tracking-tight text-foreground">
