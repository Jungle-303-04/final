  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        className={cn(
          'rounded text-muted-foreground/75 hover:bg-accent hover:text-foreground',
          triggerSize,
        )}
      >
      ...
      {open && (
        <div
          ...
          role="menu"
          className={cn(
            'absolute right-0 z-50 min-w-[180px] rounded-lg border border-border bg-card py-1 shadow-xl',
