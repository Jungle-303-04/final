    ...
    <>
      ...
      <div className="flex items-center justify-between px-2 py-1.5 border-b border-border text-xs text-muted-foreground">
        <button
          ...
          className="flex items-center gap-1 px-1.5 py-0.5 rounded hover:bg-accent disabled:opacity-50 disabled:hover:bg-transparent"
        ...
        <button
          ...
          className="px-1.5 py-0.5 rounded hover:bg-accent disabled:opacity-50 disabled:hover:bg-transparent"
        >
          {allVisibleSelected
