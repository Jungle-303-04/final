...
const SEVERITY: Record<BadgeSeverity, string> = {
  success: 'bg-success text-success border-success dark:bg-success/50 dark:text-success dark:border-success/40',
  warning: 'bg-warning text-warning-text border-warning dark:bg-warning/50 dark:border-warning/40',
  ...
  error:   'bg-destructive text-destructive border-destructive dark:bg-destructive/50 dark:text-destructive dark:border-destructive/40',
  info:    'bg-sky-100 text-sky-700 border-sky-300 dark:bg-sky-950/50 dark:text-sky-400 dark:border-sky-700/40',
  neutral: 'bg-accent/50 text-muted-foreground border-border',
}
...
const KIND: Record<string, string> = {
  // Workloads
  Deployment:    'bg-success text-success border-success dark:bg-success/50 dark:text-success dark:border-success/40',
  ...
  ReplicaSet:    'bg-success text-success border-success dark:bg-success/50 dark:text-success dark:border-success/40',
  ...
  Rollout:       'bg-success text-success border-success dark:bg-success/50 dark:text-success dark:border-success/40',
  ...
  // Config
  ConfigMap:     'bg-warning text-warning border-warning dark:bg-warning/50 dark:text-warning dark:border-warning/40',
  Secret:        'bg-destructive text-destructive border-destructive dark:bg-destructive/50 dark:text-destructive dark:border-destructive/40',
...
const TONE: Record<BadgeTone, string> = {
  ...
  structural: 'bg-popover text-muted-foreground border-border',
}
...
export function Badge({ severity, kind, protocol, tone, colorClass, size = 'default', className, onClick, title, children }: BadgeProps) {
  const color =
    ...
    (severity ? SEVERITY[severity]
      ...
      : '')
  const cls = cn(SIZE_CLASSES[size], color, className)
