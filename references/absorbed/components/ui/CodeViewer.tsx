  ...
  return (
    ...
    >
      {showCopyButton && !searchOpen && (
        <button
          onClick={handleCopy}
          className="absolute top-2 right-2 z-10 flex items-center gap-1 px-2 py-1 text-xs text-muted-foreground hover:text-foreground bg-card/80 hover:bg-popover rounded backdrop-blur-sm"
        >
      ...
      {/* Search bar */}
      {searchOpen && (
        <div className="absolute top-2 right-2 z-20 flex items-center gap-1 px-2 py-1.5 bg-card border border-border rounded-lg shadow-lg backdrop-blur-sm">
          ...
          <Input
            ...
            placeholder="Search..."
            className="w-40 bg-transparent text-xs text-foreground placeholder:text-muted-foreground/45 outline-none"
            autoFocus
          />
          {searchQuery && (
            <span className="text-xs text-muted-foreground/75 whitespace-nowrap shrink-0">
          ...
          <button
            ...
            className="p-0.5 text-muted-foreground/75 hover:text-foreground disabled:opacity-30 rounded"
          ...
          <button
            onClick={closeSearch}
            className="p-0.5 text-muted-foreground/75 hover:text-foreground rounded"
            title="Close (Escape)"
          >
      ...
      >
        {highlighting ? (
          <div className="p-4 text-muted-foreground/75 text-sm font-mono">Loading…</div>
        ) : (
          <div
            ref={contentRef}
