...
export function MetricsChart({
  ...
  if (values.length === 0) {
    return (
      <div className={cn('flex items-center justify-center text-muted-foreground/75 text-xs', className)} style={{ height }}>
        No metrics data yet
      </div>
    )
  }
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      <div className="flex">
        {/* Y-axis labels */}
        <div className="flex flex-col justify-between text-[9px] text-muted-foreground/75 pr-1 w-12 text-right font-mono" style={{ height }}>
        ...
        <div className="relative flex-1" style={{ height }}>
          ...
          <div className="absolute inset-0 flex items-end">
            {values.map((value, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(color, 'w-full rounded-t-sm opacity-70 hover:opacity-100 transition-opacity')}
          ...
          {limitPercent !== undefined && limitPercent <= 100 && (
            <div
              className="absolute left-0 right-0 border-t-2 border-destructive border-dashed pointer-events-none"
          ...
          {requestPercent !== undefined && requestPercent <= 100 && (
            <div
              className="absolute left-0 right-0 border-t-2 border-warning border-dashed pointer-events-none"
        ...
        {(limitPercent !== undefined || requestPercent !== undefined) && (
          <div className="relative w-8 pl-1" style={{ height }}>
            {limitPercent !== undefined && limitPercent <= 100 && (
              <span
                className="absolute text-[9px] text-destructive leading-none"
            ...
            {requestPercent !== undefined && requestPercent <= 100 && (
              <span
                className="absolute text-[9px] text-warning leading-none"
      ...
      {/* X-axis labels */}
      {showAxis && (
        <div className="flex justify-between text-[10px] text-muted-foreground/75 mt-1 ml-12 mr-8">
