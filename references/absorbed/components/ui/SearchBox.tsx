  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <Input
        ...
        className="w-full rounded-lg border border-border/60 bg-popover py-1.5 pl-10 pr-9 text-sm text-foreground placeholder-muted-foreground/45 focus:outline-none focus:ring-2 focus:ring-primary"
      />
      {value && (
        <button
          type="button"
          ...
          className="absolute right-2.5 top-1/2 -translate-y-1/2 text-muted-foreground/75 hover:text-foreground"
        >
