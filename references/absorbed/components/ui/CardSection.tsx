    ...
    <section className="flex items-start gap-2.5">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <h4 className={`text-[11px] font-semibold uppercase tracking-[0.06em] ${toneClass}`}>
          {label}
          {labelExtra ? <span className="font-medium normal-case tracking-normal text-muted-foreground/75"> {labelExtra}</span> : null}
        </h4>
        {children}
      </div>
    </section>
...
export const NEUTRAL_CHIP_CLASS =
  'inline-flex items-center rounded-md px-2 py-0.5 text-[11px] font-semibold leading-tight bg-popover text-muted-foreground'
...
export const KIND_CHIP_CLASS =
  'shrink-0 rounded bg-popover px-1.5 py-px font-mono text-[11px] uppercase text-muted-foreground'
