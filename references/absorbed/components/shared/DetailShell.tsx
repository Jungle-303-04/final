...
export interface DetailShellProps<TId extends string = string> {
  ...
  /** Inline leading control on the identity row — a back button in standalone Opsia. */
  nav?: ReactNode
  identity: ReactNode
      ...
      <div className="shrink-0 border-b border-border bg-background">
        {!compactHeader && (
          <>
            ...
            <div className={cn('px-6 flex items-start gap-4', breadcrumb ? 'pb-3 pt-1.5' : 'py-3')}>
              {nav}
        ...
        <div className={cn('flex items-center', compactHeader ? 'px-0' : 'border-t border-border px-6')}>
