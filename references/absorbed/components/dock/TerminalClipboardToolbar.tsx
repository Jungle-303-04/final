  ...
  return (
    <>
      <button
        ...
        className="ml-auto flex items-center gap-1 px-2 py-0.5 text-xs text-muted-foreground/75 hover:text-foreground hover:bg-popover rounded disabled:opacity-40 disabled:hover:bg-transparent disabled:cursor-default"
      >
        <Copy className="w-3 h-3" />
        Copy
      </button>
      <span className="min-w-0 truncate text-[11px] text-muted-foreground/70" title={hint}>
        {hint}
      </span>
    </>
  )
