            ...
            <tbody>
              {unhealthyConditions.map((uc: any, i: number) => (
                <tr key={i} className="border-t border-border">
                  <td className="py-1 text-muted-foreground">{uc.type}</td>
                  <td className="py-1 text-muted-foreground">{uc.status}</td>
                  <td className="py-1 text-muted-foreground">{uc.timeout}</td>
                </tr>
              ))}
            </tbody>
          </table>
