                ...
                <div key={i} className="card-inner-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      {isSecure && <Lock className="w-3.5 h-3.5 text-success" />}
                  ...
                  <div className="space-y-1 text-xs text-muted-foreground">
                    <div>
                      <span className="text-muted-foreground/75">Hosts: </span>
                    ...
                    {server.tls && (
                      <>
                        ...
                        {server.tls.credentialName && (
                          <div>
                            <span className="text-muted-foreground/75">Credential: </span>
