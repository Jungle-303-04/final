      ...
      <Section title="Status" icon={HardDrive}>
        <PropertyList>
          <Property
            ...
            value={
              <span className={cn(
                (phase === 'Bound' || phase === 'Available') && 'text-success',
                phase === 'Released' && 'text-warning',
          ...
          <Property
            ...
            value={
              spec.persistentVolumeReclaimPolicy ? (
                <span className={cn(
                  spec.persistentVolumeReclaimPolicy === 'Delete' && 'text-destructive',
                  spec.persistentVolumeReclaimPolicy === 'Retain' && 'text-success',
                )}>
                  {spec.persistentVolumeReclaimPolicy}
                </span>
              ) : undefined
