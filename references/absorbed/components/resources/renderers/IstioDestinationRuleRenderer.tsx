        ...
        <Section title="Traffic Policy" defaultExpanded>
          <div className="space-y-3">
            ...
            {trafficPolicy.connectionPool && (
              <div>
                <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Connection Pool</div>
                <PropertyList>
            ...
            {trafficPolicy.loadBalancer && (
              <div>
                <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Load Balancer</div>
                <PropertyList>
            ...
            {trafficPolicy.outlierDetection && (
              <div>
                <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">Outlier Detection</div>
                <PropertyList>
            ...
            {trafficPolicy.tls && (
              <div>
                <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1">TLS</div>
                <PropertyList>
          ...
          <div className="space-y-3">
            {subsets.map((subset, i) => (
              <div key={i} className="card-inner-lg">
                <div className="text-sm font-medium text-foreground mb-2">{subset.name}</div>
                {Object.keys(subset.labels).length > 0 && (
                  <div className="mb-2">
                    <div className="text-[10px] font-medium text-muted-foreground/75 uppercase tracking-wider mb-1">Labels</div>
