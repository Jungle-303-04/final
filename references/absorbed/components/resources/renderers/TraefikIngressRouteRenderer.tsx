          ...
          {routes.map((route: any, i: number) => {
            ...
            return (
              <div key={i} className="card-inner-lg">
                ...
                {services.length > 0 && (
                  <div className="mb-2">
                    <div className="text-[10px] font-medium text-muted-foreground/75 uppercase tracking-wider mb-1">Services</div>
                ...
                {middlewares.length > 0 && (
                  <div>
                    <div className="text-[10px] font-medium text-muted-foreground/75 uppercase tracking-wider mb-1">Middlewares</div>
                ...
                <div className="space-y-1">
                  {tls.domains.map((d: any, i: number) => (
                    <div key={i} className="text-xs">
                      {d.main && <span className="text-muted-foreground">{d.main}</span>}
                      {d.sans && d.sans.length > 0 && (
                        <span className="text-muted-foreground/75"> + {d.sans.length} SAN(s)</span>
                      )}
                    </div>
                  ))}
                </div>
