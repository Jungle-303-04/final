export interface NamespacedRef {
   ...
   * (Opsia Hub fleet search) so the same `kube-system/coredns` in two
...
export const SIDE_TONES: Record<CompareSide, {
  ...
  b: {
    chipBg: 'bg-success/90 text-success',
    containerBorder: 'border-success/40',
    containerBg: 'bg-success/10',
    rowBg: 'bg-success/15',
    rowBgHover: 'group-hover/row:bg-success/25',
  },
}
