...
describe("ApplicationDetail shell", () => {
  ...
  it('distinguishes inferred application identity from declared identity', () => {
    ...
    const declared = renderDetail({
      app: {
        ...app,
        identity: { key: 'checkout', env: 'prod', confidence: 'high', evidence: 'app.opsia.io/app=checkout', source: 'explicit' },
      },
    })
    expect(declared).toContain('Identified by the app.opsia.io/app annotation')
