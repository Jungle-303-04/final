 ...
 * toolbar, persisted to `localStorage['opsia-logs-dark']`).
 *
...
const DARK_PALETTE: LogPalette = {
  ...
  currentMatchBg: 'bg-warning/10',

  levelActiveError: 'bg-destructive/20 text-destructive border-destructive/40',
  levelActiveWarn: 'bg-warning/20 text-warning border-warning/40',
  ...
  levelBadgeError: 'bg-destructive/20 text-destructive border border-destructive/40',
  levelBadgeWarn: 'bg-warning/20 text-warning border border-warning/40',
...
const LIGHT_PALETTE: LogPalette = {
  ...
  currentMatchBg: 'bg-warning/60',

  levelActiveError: 'bg-destructive text-destructive border-destructive',
  levelActiveWarn: 'bg-warning text-warning border-warning',
  levelActiveInfo: 'bg-blue-100 text-blue-700 border-blue-400',
  levelActiveDebug: 'bg-slate-200 text-slate-700 border-slate-400',

  levelBadgeError: 'bg-destructive text-destructive border border-destructive',
  levelBadgeWarn: 'bg-warning text-warning border border-warning',
